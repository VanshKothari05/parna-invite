    ...
    >
      ...
      <div className="gate__content">
        <div className="gate__mantras">
          ...
          <p className="gate__mantra gate__mantra--2 devanagari">
            श्री वासुपूज्य स्वामी नमः
          </p>
        </div>
        ...
        <p
          className="gate__cue"
          aria-label="Click here to reveal the invitation"
        >
          <span className="gate__cue-mark" aria-hidden="true">
            ✦
          </span>
          <span className="gate__cue-text">Click here</span>
          <span className="gate__cue-mark" aria-hidden="true">
            ✦
          </span>
        </p>
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="12"
        fill="#2A0A1E"
        stroke="rgba(160,120,56,0.6)"
        strokeWidth="0.9"
      />
      {/* Lower shikhar tier */}
      <path
        d="M148,16 L180,14 L212,16 L206,28 L180,26 L154,28 Z"
        fill="#2A0A1E"
        stroke="rgba(160,120,56,0.55)"
        strokeWidth="0.9"
      />
      {/* Middle shikhar tier */}
      <path
        d="M158,28 L180,26 L202,28 L197,40 L180,38 L163,40 Z"
        fill="#2A0A1E"
        stroke="rgba(160,120,56,0.48)"
        strokeWidth="0.8"
      />
      {/* Upper spire body */}
      <path
        d="M164,40 L180,38 L196,40 L192,52 L180,50 L168,52 Z"
        fill="#2A0A1E"
        stroke="rgba(160,120,56,0.44)"
        strokeWidth="0.7"
      />
      {/* Neck */}
      <rect
      ...
      {[28, 68, 108, 180, 252, 292, 332].map((x) => (
        <path
          key={x}
          d={`M${x},84 L${x + 8},97 L${x},110 L${x - 8},97 Z`}
          stroke="rgba(160,120,56,0.42)"
          strokeWidth="0.8"
          fill="none"
        />
      ))}
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        width="134"
        height="220"
        fill="rgba(28,6,20,0.38)"
        stroke="rgba(160,120,56,0.35)"
        strokeWidth="0.8"
      />
      {/* Top panel ornament — concentric diamond */}
      <path
        d="M95,78 L120,138 L95,198 L70,138 Z"
        stroke="rgba(160,120,56,0.28)"
        strokeWidth="0.8"
        fill="none"
      />
      ...
      {Array.from({ length: 8 }, (_, i) => {
        ...
        return (
          <line
            ...
            y1={138}
            x2={95 + 22 * Math.cos(a)}
            y2={138 + 22 * Math.sin(a)}
            stroke="rgba(160,120,56,0.12)"
            strokeWidth="0.5"
          />
        );
      })}
      ...
      {[350, 422, 494].map((y) => (
        <path
          key={y}
          d={`M95,${y - 16} L111,${y} L95,${y + 16} L79,${y} Z`}
          stroke="rgba(160,120,56,0.2)"
          strokeWidth="0.7"
          fill="none"
        />
      ...
      <path
        d="M95,702 L120,762 L95,822 L70,762 Z"
        stroke="rgba(160,120,56,0.28)"
        strokeWidth="0.8"
        fill="none"
      />
  ...
  return (
    <svg width="34" height="52" viewBox="0 0 34 52" fill="none">
      <ellipse
        ...
        rx="11"
        ry="14"
        fill="rgba(240,180,80,0.2)"
        className="gate__diya-glow"
      />
      <path
    ...
    <div className={`gate__bell gate__bell--${side}`} aria-hidden="true">
      <svg width="34" height="54" viewBox="0 0 34 54" fill="none">
        ...
        <path
          ...
          stroke="var(--gold)"
          strokeWidth="1.3"
          fill="rgba(160,120,56,0.1)"
          opacity="0.9"
        />
        <path
          d="M6,25 Q17,23 28,25"
          stroke="var(--gold)"
          strokeWidth="0.65"
          fill="none"
          opacity="0.45"
